...
public class AddNewCategoryWindowViewModel : ViewModelBase
{
    ...
    private ObservableCollection<CategoryItemFileExtension> _fileExtensions;

    public ObservableCollection<CategoryItemFileExtension> FileExtensions
    {
        get => _fileExtensions;
        set => this.RaiseAndSetIfChanged(ref _fileExtensions, value);
    }

    private CategoryItemFileExtension _newFileExtension = new CategoryItemFileExtension();

    public CategoryItemFileExtension NewFileExtension
    {
    ...
    {
        FileExtensions = new ObservableCollection<CategoryItemFileExtension>();
        ...
        DeleteFileExtensionCommand = ReactiveCommand.Create<CategoryItemFileExtension?>(DeleteFileExtension);
    ...
    private void Save(Window? owner)
    {
        try
        {
            ...
            UnitOfWork.CategoryItemRepository.Add(categoryItem);
            ...
            UnitOfWork.CategoryItemFileExtensionRepository.AddRange(fileExtensions);
            ...
            UnitOfWork.CategoryItemSaveDirectoryRepository.Add(saveDirectory);
            owner.Close(true);
        }
        catch (Exception ex)
        {
    ...
    {
        return UnitOfWork.CategoryItemSaveDirectoryRepository
            .Get(where: sd => sd.CategoryItemId == null)?
            .SaveDirectory;
    }
    ...
    private void AddNewFileExtension()
    {
        ...
        var newFileExtension = new CategoryItemFileExtension
        {
        ...
        NewFileExtension = new CategoryItemFileExtension();
    }

    private void DeleteFileExtension(CategoryItemFileExtension? fileExtension)
    {
